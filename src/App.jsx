...
export default function QigongApp() {
  ...
  useEffect(() => {
    if (!cargado) return;
    try {
      localStorage.setItem("progreso-qigong", JSON.stringify({ completadas, premium, accesoCompleto, recorridosComprados, email, avisoAceptado, introVista, comoFuncionaOnboardingVista, idioma }));
    } catch (e) {}
  }, [completadas, premium, accesoCompleto, recorridosComprados, email, avisoAceptado, introVista, comoFuncionaOnboardingVista, idioma, cargado]);
