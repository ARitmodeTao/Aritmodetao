...
const TRADUCCIONES = {
  es: {
    ...
    gratisAviso: "Puedes entrar y explorar todos los recorridos gratis: la introducción y la 1ª sesión de cada uno son siempre gratuitas, sin necesidad de pagar nada.",
    precioTitulo: "Precio",
    precioPorMes: "al mes",
    ...
    volver: "Volver",
    compartir: "Compartir",
    compartirTexto: "Descubre \"A ritmo de TAO con Bea\" — recorridos de Qi Gong guiados en vídeo y audio, para recuperar energía y calma en solo 15-20 minutos al día.",
  ...
  fr: {
    ...
    gratisAviso: "Tu peux entrer et explorer tous les parcours gratuitement : l’introduction et la 1ère séance de chacun sont toujours gratuites, sans rien payer.",
    precioTitulo: "Prix",
    ...
    volver: "Retour",
    compartir: "Partager",
    compartirTexto: "Découvre « A ritmo de TAO con Bea » — des parcours de Qi Gong guidés en vidéo et audio, pour retrouver énergie et calme en seulement 15-20 minutes par jour.",
  ...
  en: {
    ...
    gratisAviso: "You can explore every journey for free: the introduction and 1st session of each one are always free, no payment needed.",
    precioTitulo: "Price",
    ...
    volver: "Back",
    compartir: "Share",
    compartirTexto: "Discover \"A ritmo de TAO con Bea\" — guided Qi Gong journeys in video and audio, to restore energy and calm in just 15-20 minutes a day.",
  ...
  de: {
    ...
    gratisAviso: "Du kannst alle Programme kostenlos erkunden: die Einführung und die 1. Sitzung sind immer gratis, ohne dass du etwas bezahlen musst.",
    precioTitulo: "Preis",
    ...
    volver: "Zurück",
    compartir: "Teilen",
    compartirTexto: "Entdecke „A ritmo de TAO con Bea\" — geführte Qi-Gong-Programme in Video und Audio, um in nur 15-20 Minuten am Tag Energie und Ruhe zurückzugewinnen.",
...
export default function QigongApp() {
  ...
  useEffect(() => {
    if (!cargado) return;
    try {
      localStorage.setItem("progreso-qigong", JSON.stringify({ completadas, premium, email, avisoAceptado, introVista, comoFuncionaOnboardingVista, idioma }));
    } catch (e) {}
  }, [completadas, premium, email, avisoAceptado, introVista, comoFuncionaOnboardingVista, idioma, cargado]);
    ...
    <div className="min-h-screen overflow-y-auto" style={{ background: "#F6F1E4" }}>
      ...
      <div className="px-7 py-8">
        ...
        >
          ...
          <p className="text-[14px] leading-snug" style={{ color: "#1B2A4A", fontFamily: "system-ui" }}>
            {t.gratisAviso}
          </p>
        </div>

        <div className="rounded-2xl p-5 mb-8" style={{ background: "#FFFFFF", border: "1px solid #E4DCC6" }}>
          <p className="text-[11px] uppercase tracking-wide mb-1" style={{ color: "#9A8158", fontFamily: "system-ui" }}>
            {t.precioTitulo}
          </p>
          <p className="text-[26px] mb-1" style={{ color: "#1B2A4A", fontFamily: "'Georgia', serif" }}>
            6,99 € <span className="text-[13px]" style={{ color: "#5C6B7A", fontFamily: "system-ui" }}>{t.precioPorMes}</span>
          </p>
          <p className="text-[12.5px] mb-4" style={{ color: "#5C6B7A", fontFamily: "system-ui" }}>
            {t.precioCancela}
          </p>
          <div className="flex flex-col gap-2">
            {t.precioLista.map((linea) => (
              <div key={linea} className="flex items-center gap-2.5">
                <Check size={15} color="#C9912A" />
                <span className="text-[13px]" style={{ color: "#3A3024", fontFamily: "system-ui" }}>
                  {linea}
                </span>
              </div>
            ))}
