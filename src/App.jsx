    ...
    bloques: [
      {
        tipo: "puntos",
        items: [
          { nombre: "Qi Hai (6VC) · Principal — La Mer de l'Énergie", localizacion: "1,5 doigt sous le nombril, ligne médiane de l'abdomen.", indicaciones: "Le point le plus tonifiant du corps pour le yang. Fatigue, faiblesse, manque de motivation, froid interne.", comoMasajear: "Paumes superposées, 9 rotations dans le sens horaire. Visualise une chaleur dorée rayonnante. En inspirant, les paumes appuient doucement ; en expirant, elles se relâchent." },
          { nombre: "Guan Yuan (4VC) · Secondaire", localizacion: "3 doigts sous le nombril.", indicaciones: "Tonifie le yuan qi et consolide le yin. Ancrage profond. Fatigue chronique profonde.", comoMasajear: "Comme pour Qi Hai. Peut être massé en même temps, avec toute la paume." },
          { nombre: "Tai Xi (R3) · Complémentaire", localizacion: "Creux entre la malléole interne et le tendon d'Achille.", indicaciones: "Nourrit le yang des reins, favorise la fertilité, agit sur le cerveau. Fatigue + vertiges + mémoire faible.", comoMasajear: "Pression délicate du pouce, des deux côtés." },
        ],
      },
    ...
    bloques: [
      {
        tipo: "puntos",
        items: [
          { nombre: "Ming Men (4VG) · Principal — La Porte du Destin", localizacion: "Ligne médiane du dos, entre la 2e et la 3e vertèbre lombaire.", indicaciones: "Le point le plus important pour la vitalité sexuelle. Stimule la sexualité, la colonne et le cerveau.", comoMasajear: "Technique taoïste : frotte les paumes jusqu'à les chauffer, masse le bas du dos 90 fois avec chaque main. Puis avec les poings fermés, en cercles." },
          { nombre: "Guan Yuan (4VC) · Secondaire", localizacion: "3 doigts sous le nombril, ligne médiane.", indicaciones: "Tonifie le yuan qi, consolide le yin. Fertilité, libido, énergie de base.", comoMasajear: "9 rotations dans le sens horaire. Visualise une chaleur dorée s'accumulant." },
          { nombre: "Tai Xi (R3) · Complémentaire", localizacion: "Entre la malléole interne et le tendon d'Achille.", indicaciones: "Nourrit le yang rénal, favorise la fertilité, tonifie l'ensemble du système. Essentiel pour la frigidité sexuelle.", comoMasajear: "Pression délicate du pouce, sur les deux pieds." },
          { nombre: "Hui Yin (1VC) · Base", localizacion: "Centre du plancher pelvien, entre l'anus et les organes génitaux.", indicaciones: "Essentiel pour l'équilibre génital et urinaire, féminin et masculin. Ne se masse pas directement.", comoMasajear: "S'active en contractant doucement le périnée à la fin de chaque inspiration, en relâchant à l'expiration — maintiens-le pendant toute la séance." },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    bloques: [
      { tipo: "automasaje", titulo: "Comment masser", texto: "Toujours assise, avec calme. Pression circulaire du pouce, 30-60 sec par point, des deux côtés." },
      {
        tipo: "puntos",
        items: [
          { nombre: "Yin Ling Quan (9Ra) · Principal", localizacion: "Face interne de la jambe, 2 doigts sous le pli du genou, contre le tibia.", indicaciones: "Le grand point drainant du corps. Élimine l'humidité, régule la rate. Œdèmes, rétention, lourdeur.", comoMasajear: "Rotations douces du pouce, des deux côtés à la fois si possible. Sensible : ne pas frapper. Quotidien." },
          { nombre: "Zu San Li (36E) · Secondaire", localizacion: "4 doigts sous la rotule, vers l'extérieur du tibia.", indicaciones: "Tonifie le qi de la rate et de l'estomac. Active le métabolisme. Le point le plus tonifiant du corps.", comoMasajear: "Tapotements doux avec le poing fermé ou pression du pouce, 60-90 sec. Très efficace debout." },
          { nombre: "Shui Fen (9VC) · Complémentaire", localizacion: "1 doigt au-dessus du nombril, ligne médiane de l'abdomen.", indicaciones: "Son nom le dit : il distribue et régule l'eau dans l'organisme. Rétention, œdèmes, fonction rénale.", comoMasajear: "Paume chaude sur le point, 9 rotations lentes dans chaque sens, en visualisant l'eau qui se draine." },
          { nombre: "Massage des Reins · Soutien", localizacion: "Ming Men et bas du dos.", indicaciones: "Active le yang rénal : le feu qui transforme l'eau en vapeur et permet le drainage.", comoMasajear: "Frotte les paumes jusqu'à les chauffer et masse le bas du dos 90 fois avec chaque main (technique taoïste)." },
        ],
      },
    ],
  },
    ...
    bloques: [
      {
        ...
        items: [
          ...
          { nombre: "Qi Men (14F) · Complémentaire", localizacion: "Sous les tétons, 6e espace intercostal.", indicaciones: "Régule toute la circulation du méridien du foie. Libère la stagnation dans le thorax, sensation de nœud dans la poitrine, colère refoulée.", comoMasajear: "Pression énergique, faire tourner dans les deux sens. Puis passer le bord des mains du centre vers les flancs." },
          { nombre: "Qu Quan (8F) · Soutien", localizacion: "Face interne du genou, entre deux tendons en fléchissant.", indicaciones: "Nourrit le sang et le foie. Lié aux perturbations de type colère et frustration.", comoMasajear: "Rotations douces ou tapotements avec la paume légèrement creuse, assise avec les jambes tendues." },
        ],
      },
    ],
  },
    ...
    bloques: [
      {
        tipo: "texto",
        texto:
          "Les digestions lourdes, les gaz, les ballonnements abdominaux et le côlon irritable combinent deux schémas : un vide de qi de la rate (le feu digestif est faible) et une invasion du foie (l'excès de qi du foie comprime l'estomac et la rate). Les symptômes s'aggravent avec le stress et les repas copieux ou froids. L'objectif : réchauffer et tonifier la rate, libérer le foie de l'estomac et activer le péristaltisme énergétique.",
      },
      {
        tipo: "patrones",
        titulo: "Schémas fréquents",
        items: [
          ...
          { nombre: "Digestion très lente / constipation fonctionnelle", texto: "Vide de yang de la rate, froid au centre. Objectif : réchauffer fortement avec le massage et le 3e Brocart." },
    ...
    bloques: [
      {
        ...
        items: [
          ...
          { nombre: "Shen Que (8VC) · Complémentaire", localizacion: "Exactement le nombril.", indicaciones: "Active la chaleur, apporte du yang aux reins et à la rate, régule les intestins et l'estomac.", comoMasajear: "Paume chaude sur le nombril, sans frotter, 2-3 minutes de chaleur seulement. Puis 9 rotations dans le sens horaire." },
          { nombre: "Di Ji (8Ra) · Soutien", localizacion: "Face interne de la jambe, au tiers entre le genou et la cheville.", indicaciones: "Élimine l'humidité et régule la rate. Digestion lente avec lourdeur et gaz.", comoMasajear: "Rotations douces du pouce, sur les deux jambes. Sensible : commencer doucement." },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    bloques: [
      { tipo: "automasaje", titulo: "Comment masser", texto: "Toujours assise, avec calme. Pression circulaire du pouce, 30-60 sec par point, des deux côtés du corps." },
      {
        tipo: "puntos",
        items: [
          { nombre: "San Yin Jiao (6Ra) · Principal", localizacion: "Face interne de la jambe, 4 doigts au-dessus de la malléole interne, contre le tibia.", indicaciones: "Tous les troubles menstruels et la ménopause. Insomnie hormonale.", comoMasajear: "Sens horaire pour tonifier (règles peu abondantes), sens antihoraire pour disperser (règles abondantes). À éviter en cas de grossesse." },
          { nombre: "Ran Gu (R2) · Secondaire", localizacion: "Face interne du pied, sur l'os naviculaire.", indicaciones: "Bouffées de chaleur ménopausiques, chaleurs nocturnes, sécheresse.", comoMasajear: "Pressions délicates, les deux pieds à la fois si possible. Idéal avant de dormir." },
          { nombre: "Qi Men (14F) · Complémentaire", localizacion: "Juste sous les tétons, 6e espace intercostal.", indicaciones: "Fonction du foie, syndrome prémenstruel, irritabilité.", comoMasajear: "Pression énergique, faire tourner dans un sens puis dans l'autre." },
          { nombre: "Ming Men (4VG) · Soutien", localizacion: "Ligne médiane du dos, entre la 2e et la 3e lombaire.", indicaciones: "Vitalité profonde, ménopause, froid pelvien.", comoMasajear: "Paumes chaudes posées sur le point, massage avec les jointures en cercles." },
        ],
      },
    ],
  },
...
const MODULOS_FR = [
  {
    id: "longevidad",
    titulo: "Longévité",
    subtitulo: "Première approche du Tao et des 8 Brocarts de Soie",
    icono: "☯",
  ...
  },
  {
    ...
    subtitulo: "Restaurer le yuan qi, tonifier les reins et réveiller le feu du dan tian",
    icono: "🔥",
  ...
  },
  {
    ...
    subtitulo: "Nourrir le jing, réveiller Ming Men et élever le feu vital des reins",
    icono: "✨",
  ...
  },
  {
    ...
    subtitulo: "Drainer l'humidité, activer la rate et libérer le qi de l'eau",
    icono: "💧",
  ...
  },
  {
    ...
    subtitulo: "Activer le feu de la rate, libérer le foie et restaurer le qi digestif",
    icono: "🌾",
  ...
  },
  {
    ...
    subtitulo: "Équilibre du Yin, du feu intérieur et de la puissance des reins",
    icono: "🌙",
  ...
  },
  {
    ...
    subtitulo: "Libérer l'excès de yang du foie, refroidir le feu et calmer le shen",
    icono: "🌿",
...
const TRADUCCIONES = {
  es: {
    ...
    freeDisclaimer: "La introducción y la 1ª práctica son gratis. El resto se desbloquea con Premium.",
    ...
    premiumFeatures: ["Todos los recorridos y sesiones", "Audio guiado por Bea", "Nuevos recorridos cada mes"],
  ...
  fr: {
    ...
    freeDisclaimer: "L'introduction et la 1ère pratique sont gratuites. Le reste se débloque avec Premium.",
    ...
    premiumFeatures: ["Tous les parcours et séances", "Audio guidé par Bea", "Nouveaux parcours chaque mois"],
  ...
  en: {
    ...
    freeDisclaimer: "The introduction and 1st practice are free. The rest unlocks with Premium.",
    ...
    premiumFeatures: ["All journeys and sessions", "Audio guided by Bea", "New journeys every month"],
  ...
  de: {
    ...
    freeDisclaimer: "Die Einführung und die 1. Übung sind kostenlos. Der Rest wird mit Premium freigeschaltet.",
    ...
    premiumFeatures: ["Alle Programme und Sitzungen", "Audio-Anleitung von Bea", "Neue Programme jeden Monat"],
...
export default function QigongApp() {
  ...
  useEffect(() => {
    if (!cargado) return;
    try {
      localStorage.setItem("progreso-qigong", JSON.stringify({ completadas, premium, email, avisoAceptado, introVista, idioma }));
    } catch (e) {}
  }, [completadas, premium, email, avisoAceptado, introVista, idioma, cargado]);
...
// ---------------------------------------------------------------------
function Modulos({ modulos, proximos, completadas, premium, onAbrir, onRestaurar, comprobando, onReiniciar, t, idioma, onCambiarIdioma }) {
      ...
      >
        ...
        {premium ? (
          ...
          <div className="flex gap-2 items-center">
            ...
            />
            <button
              onClick={() => onRestaurar(emailInput)}
...
// Pantalla: Paywall
// ---------------------------------------------------------------------
function Paywall({ estacion, onCerrar, t, emailInicial, onEmailConfirmado }) {
  ...
  const irAPagar = () => {
    ...
    const separador = STRIPE_PAYMENT_LINK.includes("?") ? "&" : "?";
    window.location.href = `${STRIPE_PAYMENT_LINK}${separador}prefilled_email=${encodeURIComponent(email)}`;
  };
