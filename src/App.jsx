...
// Contacto para ejercer derechos RGPD (acceso, rectificación, supresión...).
// Cámbialo por el email que quieras usar para este propósito.
const CONTACTO_PRIVACIDAD_EMAIL = "hola@aritmodetao.com";

// Política de Privacidad — texto completo por idioma (fallback a "es" si el
// idioma no tiene versión propia, p.ej. inglés/alemán).
    ...
    secciones: [
      {
        ...
        texto:
          "QiGong Balance — A ritmo de TAO es un proyecto operado por Bea Tobaruela (en adelante, \"nosotros\"). Para cualquier duda sobre esta política o tus datos, puedes escribirnos a " +
          CONTACTO_PRIVACIDAD_EMAIL + ".",
      },
      {
        titulo: "2. Qué datos recogemos",
        texto:
          "Recogemos únicamente los datos necesarios para darte acceso a la app: tu dirección de email (para gestionar tu compra o suscripción), y los datos de pago que procesa directamente Stripe, nuestro proveedor de pagos (nosotros nunca vemos ni almacenamos el número completo de tu tarjeta). También guardamos, en tu propio dispositivo, tu progreso dentro de la app (sesiones completadas).",
      },
      {
        titulo: "3. Para qué usamos tus datos",
        texto:
          "Usamos tu email exclusivamente para: verificar tu acceso a los contenidos que has comprado o suscrito, enviarte confirmaciones de pago o facturas (a través de Stripe), y responder si nos escribes. No usamos tu email para enviarte publicidad salvo que nos des tu consentimiento expreso y separado para ello.",
      },
      {
        titulo: "4. Base legal",
        texto:
          "Tratamos tus datos de pago y acceso en base a la ejecución del contrato (tu compra o suscripción). Cualquier comunicación adicional (como una newsletter) se basaría en tu consentimiento explícito, que siempre podrás retirar.",
      },
      {
        titulo: "5. Con quién compartimos tus datos",
        texto:
          "Compartimos los datos estrictamente necesarios con: Stripe (procesamiento de pagos) y Vercel (alojamiento técnico de la app). Ambos actúan como encargados del tratamiento bajo sus propias políticas de privacidad, conformes al RGPD. No vendemos ni cedemos tus datos a terceros con fines comerciales.",
      },
      {
        titulo: "6. Cuánto tiempo conservamos tus datos",
        texto:
          "Conservamos tu email mientras tu compra o suscripción esté activa, y durante el plazo adicional que exija la normativa fiscal y contable aplicable. Si quieres que eliminemos tu email antes de ese plazo (una vez finalizado el uso del servicio), puedes solicitarlo escribiéndonos.",
      },
      {
        titulo: "7. Tus derechos",
        texto:
          "Tienes derecho a acceder, rectificar, suprimir, limitar u oponerte al tratamiento de tus datos, así como a la portabilidad de los mismos. Puedes ejercer estos derechos escribiéndonos a " +
          CONTACTO_PRIVACIDAD_EMAIL +
          ". También tienes derecho a presentar una reclamación ante la autoridad de control de tu país (en España, la AEPD).",
      },
      {
        titulo: "8. Seguridad",
        texto:
          "Adoptamos medidas técnicas razonables para proteger tus datos, incluyendo el uso de proveedores (Stripe, Vercel) certificados y conformes con estándares de seguridad reconocidos internacionalmente.",
      },
      {
        titulo: "9. Cambios en esta política",
        texto:
          "Podemos actualizar esta política ocasionalmente. Si los cambios son significativos, te lo indicaremos de forma visible en la app.",
      },
    ],
  },
  fr: {
    ...
    secciones: [
      {
        titulo: "1. Responsable du traitement",
        texto:
          "QiGong Balance — A ritmo de TAO est un projet géré par Bea Tobaruela (ci-après, « nous »). Pour toute question concernant cette politique ou tes données, tu peux nous écrire à " +
          CONTACTO_PRIVACIDAD_EMAIL + ".",
      },
      {
        titulo: "2. Quelles données nous collectons",
        texto:
          "Nous collectons uniquement les données nécessaires pour te donner accès à l'application : ton adresse email (pour gérer ton achat ou ton abonnement), et les données de paiement traitées directement par Stripe, notre prestataire de paiement (nous ne voyons ni ne stockons jamais le numéro complet de ta carte). Nous conservons également, sur ton propre appareil, ta progression dans l'application (sessions terminées).",
      },
      {
        titulo: "3. À quoi servent tes données",
        texto:
          "Nous utilisons ton email exclusivement pour : vérifier ton accès aux contenus que tu as achetés ou auxquels tu es abonnée, t'envoyer des confirmations de paiement ou des factures (via Stripe), et te répondre si tu nous écris. Nous n'utilisons pas ton email à des fins publicitaires, sauf consentement exprès et distinct de ta part.",
      },
      {
        titulo: "4. Base légale",
        texto:
          "Nous traitons tes données de paiement et d'accès sur la base de l'exécution du contrat (ton achat ou abonnement). Toute communication additionnelle (comme une newsletter) reposerait sur ton consentement explicite, que tu peux retirer à tout moment.",
      },
      {
        titulo: "5. Avec qui nous partageons tes données",
        texto:
          "Nous partageons uniquement les données strictement nécessaires avec : Stripe (traitement des paiements) et Vercel (hébergement technique de l'application). Les deux agissent en tant que sous-traitants selon leurs propres politiques de confidentialité, conformes au RGPD. Nous ne vendons ni ne cédons tes données à des tiers à des fins commerciales.",
      },
      {
        titulo: "6. Durée de conservation",
        texto:
          "Nous conservons ton email tant que ton achat ou abonnement est actif, ainsi que pendant la durée supplémentaire exigée par la réglementation fiscale et comptable applicable. Si tu souhaites que nous supprimions ton email avant ce délai (une fois le service terminé), tu peux nous en faire la demande par écrit.",
      },
      {
        titulo: "7. Tes droits",
        texto:
          "Tu as le droit d'accéder à tes données, de les rectifier, de les supprimer, d'en limiter le traitement ou de t'y opposer, ainsi qu'un droit à la portabilité. Tu peux exercer ces droits en nous écrivant à " +
          CONTACTO_PRIVACIDAD_EMAIL +
          ". Tu as également le droit d'introduire une réclamation auprès de l'autorité de contrôle de ton pays (en France, la CNIL).",
      },
      {
        titulo: "8. Sécurité",
        texto:
          "Nous adoptons des mesures techniques raisonnables pour protéger tes données, notamment en utilisant des prestataires (Stripe, Vercel) certifiés et conformes à des standards de sécurité reconnus internationalement.",
      },
      {
        titulo: "9. Modifications de cette politique",
        texto:
          "Nous pouvons mettre à jour cette politique occasionnellement. Si les changements sont significatifs, nous te le signalerons de façon visible dans l'application.",
      },
    ],
  },
};
...
const ESTACIONES_LONGEVIDAD = [
  {
    id: 0,
    tipo: "intro",
    titulo: "¿Qué son los Ba Duan Jin?",
    sub: "Fundamentos",
    free: true,
    icono: "☯",
    duracion: "8 min",
...
const ESTACIONES_MENSTRUACION = [
  ...
  },
  {
    ...
    duracion: "8-10 min",
    videoId: "-c9VNzSdMbo",
    notaVideo: "Este vídeo es genérico: la técnica de automasaje es la misma para todos los recorridos. El audio y el texto sí incluyen pequeñas variaciones específicas para este recorrido.",
  ...
  },
  {
    ...
    duracion: "10-12 min",
    videoId: "NkbcZK_XEss",
    notaVideo: "Este vídeo muestra el ejercicio completo y genérico del Ciervo. Si buscas una variación más específica para este recorrido, consulta el texto de esta estación.",
    bloques: [
      {
        tipo: "movimiento",
...
const ESTACIONES_RETENCION = [
  ...
  },
  {
    ...
    duracion: "10-12 min",
    videoId: "2TcEfblCI4A",
    notaVideo: "Este vídeo muestra el ejercicio completo y genérico del Oso. Si buscas una variación más específica para este recorrido, consulta el texto de esta estación.",
    bloques: [
      {
        tipo: "movimiento",
...
const ESTACIONES_VITALIDAD = [
  ...
  },
  {
    ...
    duracion: "20 min",
    videoId: "NkbcZK_XEss",
    videoLabel1: "El Ciervo",
    videoId2: "Lfsa6WQ-BlQ",
    videoLabel2: "El Tigre",
    notaVideo: "Estos vídeos muestran el ejercicio completo y genérico de cada animal. Si buscas una variación más específica para este recorrido, consulta el texto de esta estación.",
    bloques: [
      {
        tipo: "movimiento",
...
const ESTACIONES_LONGEVIDAD_FR = [
  {
    id: 0,
    tipo: "intro",
    titulo: "Qu'est-ce que les Ba Duan Jin ?",
    sub: "Fondamentaux",
    free: true,
    icono: "☯",
    duracion: "8 min",
    videoId: "qDGCuNPAYp4",
    audioArchivo: "longevidad-intro-fr.mp3",
    bloques: [
      {
        tipo: "texto",
        texto:
...
const ESTACIONES_ENERGIA_FR = [
  ...
  },
  {
    ...
    duracion: "10 min",
    videoId: "-c9VNzSdMbo",
    notaVideo: "Cette vidéo est générique : la technique d'automassage est la même pour tous les parcours. L'audio et le texte incluent de légères variations spécifiques à ce parcours.",
    bloques: [
      {
        tipo: "automasaje",
  ...
  },
  {
    ...
    videoId: "",
    imagen: "arbol-postura.jpg",
    audioArchivo: "arbol-energia-fr.mp3",
    bloques: [
...
const ESTACIONES_VITALIDAD_FR = [
  ...
  },
  {
    ...
    videoLabel1: "Le Cerf",
    videoId2: "Lfsa6WQ-BlQ",
    videoLabel2: "Le Tigre",
    notaVideo: "Ces vidéos montrent l'exercice complet et générique de chaque animal. Pour une variation plus spécifique à ce parcours, consulte le texte de cette station.",
    bloques: [
  ...
  },
  {
    ...
    videoId: "",
    imagen: "arbol-postura.jpg",
    audioArchivo: "arbol-vitalidad-sexual-fr.mp3",
    bloques: [
...
const ESTACIONES_RETENCION_FR = [
  ...
  },
  {
    ...
    duracion: "10-12 min",
    videoId: "2TcEfblCI4A",
    notaVideo: "Cette vidéo montre l'exercice complet et générique de l'Ours. Pour une variation plus spécifique à ce parcours, consulte le texte de cette station.",
    bloques: [
  ...
  },
  {
    ...
    videoId: "",
    imagen: "arbol-postura.jpg",
    audioArchivo: "arbol-retencion-liquidos-fr.mp3",
    bloques: [
...
const ESTACIONES_DIGESTION_FR = [
  ...
  },
  {
    ...
    videoId: "",
    imagen: "arbol-postura.jpg",
    audioArchivo: "arbol-digestiones-fr.mp3",
    bloques: [
...
const ESTACIONES_MENSTRUACION_FR = [
  ...
  },
  {
    ...
    duracion: "10-12 min",
    videoId: "NkbcZK_XEss",
    notaVideo: "Cette vidéo montre l'exercice complet et générique du Cerf. Pour une variation plus spécifique à ce parcours, consulte le texte de cette station.",
    bloques: [
  ...
  },
  {
    ...
    videoId: "",
    imagen: "arbol-postura.jpg",
    audioArchivo: "arbol-ciclos-femeninos-fr.mp3",
    bloques: [
...
const TRADUCCIONES = {
  es: {
    ...
    planSuscripcionDesc: "Todo, para siempre — más contenido VIP en exclusiva: vídeos cortos sobre temas específicos, acceso a futuras clases en directo, y sé la primera en recibir cada novedad.",
    ...
    precioLista: [
      ...
      "🌟 Acceso ilimitado a nuevos recorridos",
      "🌟 Vídeos VIP sobre temas concretos",
      "🌟 Acceso a futuras clases en directo",
      "🌟 Sé la primera en recibir cada actualización",
    ],
    ...
    opcionSuscripcionDesc: "Todo, incluidas las novedades futuras, más contenido VIP y acceso prioritario. Cancela cuando quieras.",
    continuarPago: "Continuar al pago",
    aceptoPoliticaTexto: "He leído y acepto la Política de Privacidad",
    verPoliticaLink: "Ver política",
    errorAceptarPolitica: "Debes aceptar la Política de Privacidad para continuar.",
    politicaPrivacidadTitulo: "Política de Privacidad",
    politicaPrivacidadCerrar: "Cerrar",
    labelAudioGuiado: "Audio guiado",
    labelIndicaciones: "Indicaciones",
    labelComoMasajear: "Cómo masajear",
    reset: "Reiniciar",
  ...
  fr: {
    ...
    planSuscripcionDesc: "Tout, pour toujours — plus du contenu VIP en exclusivité : petites vidéos sur des sujets spécifiques, accès aux futurs cours en direct, et sois la première à recevoir chaque nouveauté.",
    ...
    precioLista: [
      ...
      "🌟 Accès illimité aux nouveaux parcours",
      "🌟 Vidéos VIP sur des sujets précis",
      "🌟 Accès aux futurs cours en direct",
      "🌟 Sois la première à recevoir chaque nouveauté",
    ],
    ...
    opcionSuscripcionDesc: "Tout, y compris les nouveautés futures, plus du contenu VIP et un accès prioritaire. Annule quand tu veux.",
    continuarPago: "Continuer vers le paiement",
    aceptoPoliticaTexto: "J'ai lu et j'accepte la Politique de Confidentialité",
    verPoliticaLink: "Voir la politique",
    errorAceptarPolitica: "Tu dois accepter la Politique de Confidentialité pour continuer.",
    politicaPrivacidadTitulo: "Politique de Confidentialité",
    politicaPrivacidadCerrar: "Fermer",
    labelAudioGuiado: "Audio guidé",
    labelIndicaciones: "Indications",
    labelComoMasajear: "Comment masser",
    reset: "Réinitialiser",
  ...
  en: {
    ...
    aceptoPoliticaTexto: "I have read and accept the Privacy Policy",
    verPoliticaLink: "View policy",
    errorAceptarPolitica: "You must accept the Privacy Policy to continue.",
    politicaPrivacidadTitulo: "Privacy Policy",
    politicaPrivacidadCerrar: "Close",
    labelAudioGuiado: "Guided audio",
    labelIndicaciones: "Guidance",
    labelComoMasajear: "How to massage",
    reset: "Reset",
  ...
  de: {
    ...
    aceptoPoliticaTexto: "Ich habe die Datenschutzrichtlinie gelesen und akzeptiere sie",
    verPoliticaLink: "Richtlinie ansehen",
    errorAceptarPolitica: "Du musst die Datenschutzrichtlinie akzeptieren, um fortzufahren.",
    politicaPrivacidadTitulo: "Datenschutzrichtlinie",
    politicaPrivacidadCerrar: "Schließen",
    labelAudioGuiado: "Geführtes Audio",
    labelIndicaciones: "Hinweise",
    labelComoMasajear: "Massageanleitung",
    reset: "Zurücksetzen",
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-7 py-10" style={{ background: "#F6F1E4" }}>
      ...
      <div
        ...
        style={{ aspectRatio: "4 / 3", background: "#0F1B2D" }}
      >
        <img
          src="/images/arbol-postura.jpg"
          alt="Bea en la postura de meditación del árbol"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(15,27,45,0.55) 0%, rgba(15,27,45,0.05) 45%, rgba(15,27,45,0) 70%)",
          }}
        />
        <div className="absolute left-4 bottom-3.5 flex items-center gap-2">
          ...
          <span
            className="text-[13px]"
            style={{ color: "#F6F1E4", fontFamily: "system-ui", fontWeight: 600 }}
          >
            QiGong Balance · A ritmo de TAO
          </span>
        </div>
      </div>
...
function Beneficios({ onContinuar, t, idioma, onCambiarIdioma }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-7 py-10" style={{ background: "#F6F1E4" }}>
      ...
      >
        <img
          src="/images/bea-qigong-2.jpg"
          alt="Bea practicando Qi Gong"
          className="w-full h-full"
          ...
          <>
            ...
            {estacion.videoId && (
              <>
                {estacion.notaVideo && (
                  <div
                    className="w-full rounded-xl px-4 py-3 mb-3 flex items-start gap-2"
                    style={{ background: "#FDF6E9", border: "1px solid #E9C77B" }}
                  >
                    <span style={{ fontSize: 16, lineHeight: "20px" }}>📌</span>
                    <p style={{ fontSize: 13, lineHeight: "18px", color: "#5C4A28", fontFamily: "system-ui" }}>
                      {estacion.notaVideo}
                    </p>
                  </div>
                )}
                {estacion.videoLabel1 && (
                ...
                {estacion.videoId2 && (
                  <>
                    {estacion.videoLabel2 && (
                      <p style={{ fontSize: 14, fontWeight: 600, color: "#1B2A4A", margin: "14px 0 6px" }}>
                        {estacion.videoLabel2}
                      </p>
                    )}
                    <div
                      ...
                      style={{
                        aspectRatio: "9 / 16",
                        background: "#0F1B2D",
                        marginTop: estacion.videoLabel2 ? 0 : 14,
                      }}
                    >
                      <iframe
                        className="w-full h-full"
                        src={`https://www.youtube.com/embed/${estacion.videoId2}`}
                        title={`${estacion.titulo} 2`}
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                        style={{ border: "none" }}
                      />
          ...
          <div key={i} className="rounded-xl overflow-hidden" style={{ background: "#FFFFFF", border: "1px solid #E4DCC6" }}>
            ...
            <div className="p-4">
              ...
              <p className="text-[12.5px] leading-snug mb-1.5" style={{ color: "#5C6B7A", fontFamily: "system-ui" }}>
                <strong style={{ color: "#3A3024" }}>{t.labelIndicaciones}: </strong>
                {p.indicaciones}
              </p>
              <p className="text-[12.5px] leading-snug" style={{ color: "#5C6B7A", fontFamily: "system-ui" }}>
                <strong style={{ color: "#3A3024" }}>{t.labelComoMasajear}: </strong>
                {p.comoMasajear}
              </p>
            </div>
          </div>
...
// ---------------------------------------------------------------------
function PoliticaPrivacidadModal({ idioma, t, onCerrar }) {
  const contenido = POLITICA_PRIVACIDAD[idioma] || POLITICA_PRIVACIDAD.es;
  return (
    <div
      className="fixed inset-0 z-50 flex flex-col justify-end"
      style={{ background: "rgba(15,27,45,0.55)" }}
    >
      <div className="rounded-t-3xl px-7 pt-7 pb-9 max-h-[85vh] overflow-y-auto" style={{ background: "#F6F1E4" }}>
        <div className="flex justify-between items-start mb-4">
          <h2 className="text-xl" style={{ color: "#1B2A4A", fontFamily: "system-ui", fontWeight: 700 }}>
        ...
        <p className="text-[11px] uppercase tracking-wide mb-4" style={{ color: "#9A8158", fontFamily: "system-ui" }}>
          {contenido.actualizado}
        </p>
        {contenido.secciones.map((s, i) => (
          <div key={i} className="mb-4">
            <p className="text-[13.5px] mb-1" style={{ color: "#1B2A4A", fontFamily: "system-ui", fontWeight: 700 }}>
              {s.titulo}
            </p>
            <p className="text-[13px] leading-relaxed" style={{ color: "#3A3024", fontFamily: "system-ui" }}>
              {s.texto}
            </p>
          </div>
        ))}
...
// Pantalla: Paywall
// ---------------------------------------------------------------------
function Paywall({ estacion, moduloId, onCerrar, t, emailInicial, onEmailConfirmado, idioma }) {
  ...
  const irAPagar = () => {
    ...
    if (!aceptaPolitica) {
      setError(t.errorAceptarPolitica);
      return;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col justify-end" style={{ background: "rgba(15,27,45,0.55)" }}>
      <div className="rounded-t-3xl px-7 pt-7 pb-9 max-h-[92vh] overflow-y-auto" style={{ background: "#F6F1E4" }}>
        ...
        <label className="flex items-start gap-2.5 mb-4 cursor-pointer select-none">
          <input
            ...
            style={{ width: 16, height: 16, accentColor: "#1B2A4A" }}
          />
          <span className="text-[12.5px] leading-snug" style={{ color: "#3A3024", fontFamily: "system-ui" }}>
            {t.aceptoPoliticaTexto}
            {" — "}
            <button
              type="button"
              onClick={(e) => {
      ...
      {mostrarPolitica && (
        <PoliticaPrivacidadModal idioma={idioma} t={t} onCerrar={() => setMostrarPolitica(false)} />
      )}
    </div>
  );
}
