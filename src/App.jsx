...
export default function QigongApp() {
  ...
  useEffect(() => {
    if (!cargado) return;
    try {
      localStorage.setItem("progreso-qigong", JSON.stringify({ completadas, premium, avisoAceptado, introVista, idioma }));
    } catch (e) {}
  }, [completadas, premium, avisoAceptado, introVista, idioma, cargado]);
...
// ---------------------------------------------------------------------
function Modulos({ modulos, proximos, completadas, premium, onAbrir, onTogglePremium, onReiniciar, t, idioma, onCambiarIdioma }) {
  return (
    <div className="pb-12">
      <div
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          >
            {premium ? t.demoPremiumOn : t.demoPremiumOff}
          </button>
          <button
            onClick={onReiniciar}
            className="text-[11px] px-3 py-1.5 rounded-full border"
...
// Pantalla: Paywall
// ---------------------------------------------------------------------
function Paywall({ estacion, onCerrar, onDesbloquear, t }) {
  return (
